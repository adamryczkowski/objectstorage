...
testthat::test_that("Test whether the code can create a new storage", {
  ...
  testthat::expect_false(file.exists(paste0(idx, getOption('index.extension'))))
  create_objectstorage(idx)
  testthat::expect_true(file.exists(paste0(idx, getOption('index.extension'))))
  create_objectstorage(idx)
  testthat::expect_true(file.exists(paste0(idx, getOption('index.extension'))))
  ans<-readRDS(paste0(idx, getOption('index.extension')))
